...
app.use('/api/about_us', routes.aboutUs, function(req, res, next){
 ...
 app.use('/api/aux_fourneaux/categorie_aliments/aliments', routes.aliments, function(req, res, next){
   next()
 })
app.use('/api/aux_fourneaux', routes.auxFourneaux, function(req, res, next){
  next()
})
app.use('/api/aux_fourneaux/categorie_aliments', routes.categorieAlim, function(req, res, next){
  next()
})
app.use('/api/aux_fourneaux/categorie_recettes', routes.categorieRecettes, function(req, res, next){
  next()
})
app.use('/api/categorie_podcast_article', routes.categoriePodcastArticle, function(req, res, next){
  next()
})
app.use('/api/connexion_admin', routes.connexionAdmin, function(req, res, next){
  next()
})
